![header](https://capsule-render.vercel.app/api?type=waving&height=230&color=0:0D1117,50:1F6FEB,100:8A2BE2&text=ALVIN0&fontColor=FFFFFF&fontSize=62&fontAlignY=38&desc=Simple%20for%20life%20%E2%80%A2%20Developer%20Tools%20Builder&descAlignY=58&animation=fadeIn)
...
I enjoy turning complex developer workflows into simple, fast, and useful tools.

- 🛠️ Building developer productivity tools
- ⚙️ Working with TypeScript, Bun, Node.js, PHP, Laravel
- 🧩 Creating VS Code extensions and API integrations
- 🚀 Interested in automation, AI-assisted workflows, and lightweight systems
- ✨ Philosophy: **simple interface, useful core, fast feedback**
...
[![My Skills](https://skillicons.dev/icons?i=ts,js,nodejs,bun,php,laravel,react,vscode,github,githubactions,docker,cloudflare,vercel,mysql,redis,linux,apple\&perline=9)](https://skillicons.dev)
